...
{
    public class PlaceOccupiedDomainEventHandlerTest : IDisposable
    {
        [Fact]
        public async void Handle()
        {
            ...
            var handler = new PlaceOccupiedDomainEventHandler(eventBus.Object, mediator.Object);
            
            // Act
            var domainEvent = new PlaceOccupiedDomainEvent(Guid.NewGuid(), "Test");
            ...
            var calledEvent = @event as PlaceOccupiedIntegrationEvent;
