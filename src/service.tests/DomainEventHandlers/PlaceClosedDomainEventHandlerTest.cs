...
{
    public class PlaceClosedDomainEventHandlerTest : IDisposable
    {
        [Fact]
        public async void Handle()
        {
            ...
            var handler = new PlaceClosedDomainEventHandler(eventBus.Object, mediator.Object);
            
            // Act
            var domainEvent = new PlaceClosedDomainEvent(Guid.NewGuid(), "Test");
            ...
            var calledEvent = @event as PlaceClosedIntegrationEvent;
